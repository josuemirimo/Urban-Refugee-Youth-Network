class SiteNav extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
      <nav class="site-nav" role="navigation" aria-label="Main navigation">
        <div class="nav-left">
          <a href="index.html">
            <img src="assets/images/logo_landscape.png" alt="Urban Refugee Youth Network Logo" class="nav-logo" onerror="this.alt='Logo unavailable';">
          </a>
        </div>
  ...
  initNavigation() {
    ...
    this.querySelectorAll('.nav-links a').forEach(a => {
      const page = a.dataset.page || 'index.html';
      if (current === page) {
    ...
    this.innerHTML = `
      <footer class="site-footer" role="contentinfo">
        <div class="footer-columns">
          <div>
            <a href="index.html">
              <img src="assets/images/logo_landscape.png" alt="Urban Refugee Youth Network Logo" class="footer-logo" onerror="this.alt='Logo unavailable';">
            </a>
          ...
          <div>
            ...
            <div class="social-links">
              <a href="https://www.facebook.com/profile.php?id=61562093632423" aria-label="Facebook" target="_blank" rel="noopener"><i class="bi bi-facebook"></i></a>
              <a href="https://www.instagram.com/urbanrefugeeyouthnetwork/" aria-label="Instagram" target="_blank" rel="noopener"><i class="bi bi-instagram"></i></a>
              <a href="https://x.com/refugee_net" aria-label="Twitter/X" target="_blank" rel="noopener"><i class="bi bi-twitter-x"></i></a>
              <a href="https://www.linkedin.com/company/urbanrefugeeyouthnetwork" aria-label="LinkedIn" target="_blank" rel="noopener"><i class="bi bi-linkedin"></i></a>
              <a href="https://www.youtube.com/@urbanrefugeeyouthnetwork-uryn" aria-label="YouTube" target="_blank" rel="noopener"><i class="bi bi-youtube"></i></a>
            </div>
          </div>
          <div>
